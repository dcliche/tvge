...
void Model::createIndexBuffers(const std::vector<uint32_t>& indices) {
    ...
    m_device.createBuffer(bufferSize, VK_BUFFER_USAGE_INDEX_BUFFER_BIT,
                          VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, m_indexBuffer,
                          m_indexBufferMemory);
